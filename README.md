...
[![Version](https://img.shields.io/badge/version-1.2.3-019999)](https://github.com/dere-w4eyt/realgorilla-browser/releases)
...
- 🔐 **Account System** — Login with Google or Email, same account across browser and extensions store
- 👤 **User Profiles** — Custom username, avatar, bio, and public profile pages
...
|----------|---------|----------|
| 🪟 **Windows** | v1.2.3 | [Setup.exe](https://github.com/dere-w4eyt/realgorilla-browser/releases/latest) or [Portable ZIP](https://github.com/dere-w4eyt/realgorilla-browser/releases/latest) |
...
### Windows
1. Download `RealGorillaBrowser Setup 1.2.3.exe`
2. Run the installer
...
## 🔐 Accounts & Extensions Store

RealGorilla Browser features a full account system and extensions ecosystem:

- **Login** with Google or Email/Password
- **Profile pages** with custom username, avatar, and bio
- **Extensions Store** with categories, search, ratings, and reviews
- **Developer Dashboard** to manage your submissions
- **VirusTotal scanning** on all extension uploads
- **Same account** works across the browser and the extensions store

Visit the [Extensions Store](https://dere-w4eyt.github.io/realgorillaos-site/extensions.html) to browse, submit, and review extensions.
