...
The official browser of **RealGorillaOS** — a Gorilla Tag themed, cross-platform web browser with built-in AI.

[![Version](https://img.shields.io/badge/version-1.1.0-019999)](https://github.com/dere-w4eyt/realgorilla-browser/releases)
...
- 🤖 **Built-in AI** — Free chatbot powered by OpenRouter (secure proxy)
- 🔒 **Privacy First** — API keys hidden via Cloudflare proxy
- 🎮 **WebGL 2.0** — Play Krunker, Minecraft Classic, and more
- 🔖 **Bookmarks** — Save, open, and delete your favorites
- 📥 **Downloads Manager** — View downloaded files
- ⚙️ **Settings** — Customize homepage and search engine
- 🆕 **New Tab Page** — Google search + quick shortcuts
- 📱 **Mobile Support** — Android APK available
- 🐧 **Linux Support** — Portable AppImage-style build
...
### Windows
1. Download `RealGorillaBrowser Setup 1.1.0.exe`
2. Run the installer
